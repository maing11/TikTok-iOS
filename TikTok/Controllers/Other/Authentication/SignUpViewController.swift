...
//        signInButton.addTarget(self, action: #selector(didTapSignIn), for: .touchUpInside)
    ...
    @objc func didTapSignUp() {
        ...
        guard let username = usernameField.text,
            ...
            let alert = UIAlertController(title: "Oops", message: "Please make sure to enter a valid username, email, and password. Your password must be atleast 6 characters long", preferredStyle: .alert)
